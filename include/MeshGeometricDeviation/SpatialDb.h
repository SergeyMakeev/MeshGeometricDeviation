...
class SpatialDb
{
  public:
    ...
    struct ClosestPointResult
    {
        ...
        ClosestPointResult();
        ClosestPointResult(const Vector3& p, bool matched, unsigned int triIdx = 0, double u = 0, double v = 0, double w = 0);
    };
  ...
  private:
    ...
    Vector3 closestPointOnTriangleWithBary(const Vector3& p, const TriangleData& tri, double& distSq, double& baryU, double& baryV,
                                           double& baryW) const;
    ...
    void searchNodeWithNormal(const KdNode* node, const Vector3& query, const Vector3& desiredNormal, double minDotProduct,
                              Vector3& closestPoint, double& minDistSq) const;
    void searchNodeWithNormalDetailed(const KdNode* node, const Vector3& query, const Vector3& desiredNormal, double minDotProduct,
